...
Load balancer reduces downtime by equally distributing traffic between servers. Jump box sits in front of other network machines to restrict public access to important machines.
